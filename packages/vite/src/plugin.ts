...
const GITIGNORE_CONTENTS = ["# Generated by @better-translate/vite", ".bt-manifest.json", ".bt-runtime.json", ""].join("\n")
...
export function betterTranslatePlugin(options: BetterTranslatePluginOptions): Plugin {
  ...
  function buildLoadMessagesModule() {
    ...
    const importLines = locales.map((locale) => `import messages_${locale} from "./${locale}.json"`)
